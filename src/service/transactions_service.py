...
class TransactionsService:
    ...
    def create(self, portfolio_id, asset_id, transaction_type, transaction_quantity,
        ...
        if transaction_type == "BUY":
            transaction_total, balance_after_transaction = self.create_buy_transaction(self, portfolio_id, asset_id, transaction_quantity, transaction_price)
        if transaction_type == "SELL":
            transaction_total, balance_after_transaction = self.create_sell_transaction(self, portfolio_id, asset_id, transaction_quantity, transaction_price)
        if transaction_type == "DEPOSIT":
            balance_after_transaction = self.create_deposit_transaction(self, portfolio_id, transaction_total)    
        if transaction_type == "WITHDRAW": 
            balance_after_transaction = self.create_withdraw_transaction(self, portfolio_id, transaction_total)
    ...
    def _create_deposit_transaction(self, portfolio_id, amount):
        ...
        portfolio = self._get_portfolio(portfolio_id)
        new_balance = portfolio.portfolio_balance + amount
    ...
    def get_transactions_by_portfolio(self, portfolio_id):
        return self.transaction_dao.get_transaction_by_portfolio(portfolio_id)

    def get_transactions_by_asset(self, portfolio_id, asset_id):
        return self.transaction_dao.get_transaction_by_asset(asset_id)

    def get_transactions_by_type(self, transaction_type):
        return self.transaction_dao.get_transaction_by_type(transaction_type)

    def get_transactions_by_date_range(self, start_date, end_date):
        if start_date > end_date:
            raise InvalidDateRange(start_date, end_date)
        return self.transaction_dao.get_transactions_by_date_range(start_date, end_date)

    def get_transactions_by_portfolio_and_date_range(self, portfolio_id, start_date, end_date):
        if start_date > end_date:
                    raise InvalidDateRange(start_date, end_date)
        return self.transaction_dao.get_transactions_by_portfolio_and_date_range(portfolio_id, start_date, end_date)

    def get_transaction_count_by_portfolio(self, portfolio_id):
        return  self.transaction_dao.get_transaction_count_by_portfolio(portfolio_id)
    
    def get_total_transaction_value_by_portfolio(self, portfolio_id):
        return self.transaction_dao.get_total_transaction_value_by_portfolio(portfolio_id)

    def get_average_transaction_price_by_asset(self, asset_id):
        return self.transaction_dao.get_average_transaction_price_by_asset(asset_id)
    
    def get_transaction_summary_by_portfolio(self, portfolio_id):
        return self.transaction_dao.get_transaction_summary_by_portfolio(portfolio_id)
    ...
    def insert_transaction(self, portfolio_id, asset_id, transaction_type, transaction_quantity,
        ...
        return self.transaction_dao.insert_transaction(portfolio_id, asset_id, transaction_type, transaction_quantity,
                            transaction_price, transaction_date, transaction_total, balance_after_transaction)
    ...
    def update_transaction(self, transaction_id, transaction_type, transaction_quantity,
        ...
        return self.transaction_dao.update_transaction(transaction_id, transaction_type, transaction_quantity,
                            transaction_price, transaction_total, balance_after_transaction)

    def delete_transaction(self, transaction_id):
        logger.info(f"Deleting transaction: transaction_id={transaction_id}")
        self. _validate_transaction_id(transaction_id)
        return self.transaction_dao.delete_transaction(transaction_id)
    ...
    def delete_transactions_by_portfolio(self, portfolio_id):
        ...
        self. _validate_portfolio_id(portfolio_id)
        return self.transaction_dao.delete_transactions_by_portfolio(portfolio_id)
